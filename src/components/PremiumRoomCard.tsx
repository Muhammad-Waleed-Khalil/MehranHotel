        ...
        <div className="relative h-full">
          ...
          <div className="absolute top-4 right-4 z-20">
            <div className="bg-black/80 backdrop-blur-sm rounded-lg p-3 text-center">
              <div className="text-gold font-bold text-lg">PKR {price.toLocaleString()}</div>
              {originalPrice && (
                <div className="text-cream-dark text-xs line-through">PKR {originalPrice.toLocaleString()}</div>
              )}
              <div className="text-cream text-xs">per night</div>
            </div>
          </div>
